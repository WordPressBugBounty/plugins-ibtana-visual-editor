...
function enqueue_admin_styles() {
  wp_register_style('ive-custom-fields', plugin_dir_url(__FILE__) . 'assets/ive-cf-admin.css', array(), '1.0.1', 'all');
...
// meta create custom fields start //
  ...
  <div class="ive-fields-builder-wrap">
  <table class="wc-item-table" width="100%">
    <tbody>
      ...
      if( $custom_repeater_item ){
        foreach( $custom_repeater_item as $item_key => $item_value ){
          ...
          <tr class="wc-sub-row">
            <td>
              <p class="ive-field-label"><?php esc_html_e( 'Title:', 'ibtana-visual-editor' );?></p>
              <input class="ive-field-input" name="<?php echo esc_attr('custom_repeater_item['.$item_key.'][f_title]'); ?>" type="text" value="<?php echo (isset($item_value['f_title'])) ? esc_attr($item_value['f_title']) : ''; ?>" style="width:98%;" placeholder="Field Title" required>
            </td>
            <td>
              <p class="ive-field-label"><?php esc_html_e( 'Name:', 'ibtana-visual-editor' );?></p>
              <input class="ive-field-input" name="<?php echo esc_attr('custom_repeater_item['.$item_key.'][f_name]'); ?>" type="text" value="<?php echo (isset($item_value['f_name'])) ? esc_attr($item_value['f_name']) : ''; ?>" style="width:98%;" placeholder="Field Name" required>
            </td>
            <td>
              <p class="ive-field-label"><?php esc_html_e( 'Type:', 'ibtana-visual-editor' );?></p>
              <?php
              ...
              ?>
              <select class="ive-field-select" name="custom_repeater_item[<?php echo $item_key; ?>][f_type]" style="width:98%;">
            ...
            <td class="ive-action-cell">
              <button class="wc-remove-item button button-secondary" type="button"><?php esc_html_e( 'Remove', 'ibtana-visual-editor' );?></button>
            </td>
          </tr>
          <?php
        }
      ...
      <tr class="wc-hide-tr" style="display: none;">
        <td>
          <p class="ive-field-label"><?php esc_html_e( 'Title:', 'ibtana-visual-editor' );?></p>
          <input class="ive-field-input" name="hide_custom_repeater_item[rand_no][f_title]" type="text" value=""  placeholder="Field Title" style="width:98%;">
        </td>
        <td>
          <p class="ive-field-label"><?php esc_html_e( 'Name:', 'ibtana-visual-editor' );?></p>
          <input class="ive-field-input" name="hide_custom_repeater_item[rand_no][f_name]" type="text" value=""  placeholder="Field Name" style="width:98%;">
        </td>
        <td>
          <p class="ive-field-label"><?php esc_html_e( 'Type:', 'ibtana-visual-editor' );?></p>
          <select class="ive-field-select" name="hide_custom_repeater_item[rand_no][f_type]" style="width:98%;">
            <option value="text"><?php esc_html_e( 'Text', 'ibtana-visual-editor' );?></option>
            <option value="repeater"><?php esc_html_e( 'Repeater', 'ibtana-visual-editor' );?></option>
    ...
    <tfoot>
      <tr>
        <td colspan="4"><button class="wc-add-item button button-primary" type="button"><?php esc_html_e( 'Add field', 'ibtana-visual-editor' );?></button></td>
      </tr>
    </tfoot>
  </table>
  </div>
